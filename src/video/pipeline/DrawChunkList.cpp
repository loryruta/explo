...
void DrawChunkList::record(VkCommandBuffer cmd_buf, vren::resource_container &resource_container)
{
    ...
    m_basic_renderer.make_rendering_scope(
        cmd_buf,
        fb_size,
        ...
        *m_renderer.m_depth_buffer,
        [&]()
        {
            ...
            m_basic_renderer.set_push_constants(
                cmd_buf,
                vren::basic_renderer::push_constants{
    ...
    resource_container.add_resources(m_renderer.m_gbuffer, m_renderer.m_depth_buffer, vertex_buffer, index_buffer, instance_buffer);
}
...
vren::render_graph_t DrawChunkList::create_render_graph_node(vren::render_graph_allocator &allocator)
{
    ...
    node->set_callback(
        [this](uint32_t frame_idx, VkCommandBuffer cmd_buf, vren::resource_container &resource_container)
        {
