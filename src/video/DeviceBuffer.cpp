...
DeviceBuffer::DeviceBuffer(Renderer &renderer, VkMemoryPropertyFlags memory_properties, VkBufferUsageFlags buffer_usages, size_t init_size) :
    m_renderer(renderer),
...
void DeviceBuffer::perform_copy(VkCommandBuffer command_buffer, vren::resource_container &resource_container, CopyOp const &copy_op)
{
